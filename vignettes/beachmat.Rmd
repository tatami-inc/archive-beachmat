...
For character matrices, `X` should point to an array of `Rcpp::String` objects, and `get` will return a `Rcpp::String`.
...
Specifically, a pointer to the column could be directly returned rather than copying the data to an array.
