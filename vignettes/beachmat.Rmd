...
For integer and logical matrices, `get` will return an integer, and `X` can be an `interator` of `Rcpp::IntegerVector`, `Rcpp::LogicalVector` or `Rcpp::NumericVector`.
...
For `integer_matrix` instances, integer values are not coerced to `{0, 1}`.
